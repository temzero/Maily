...
export default function ColorPickerButton(props: ColorPickerButtonProps) {
    ...
    const displayColor = (): string => (hasColor() ? props.color! : 'transparent');
    ...
    const calculatePosition = () => {
        ...
        // Top-left corner of the color div + offsets
    ...
    return (
        <div class="relative group">
            <div
                ...
                onClick={handleOpen}
                title={props.label || (hasColor() ? (props.color ?? 'transparent') : 'transparent')}
            >
                {!hasColor() && (
            ...
            <Show when={open()}>
                <Portal>
                    <div class="fixed inset-0 z-99998" onClick={() => setOpen(false)} />
                    <div
                        class="fixed z-99999"
                        style={{
