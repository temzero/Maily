...
import RenderAttachments, { RenderAttachmentMode } from '~/components/attachment/RenderAttachments';
...
export default function ComposeStep(props: Props) {
    ...
    return (
        <div class="relative w-full min-h-screen flex-1 flex justify-center items-center">
            <ComposeEditor />
            <ComposeActions setAttachments={props.setAttachments} attachments={props.attachments} />
            <Motion {...animations.slideUp} class="w-150">
                <div id="compose-paper" class="paper">
                    <div>
                        <textarea
                            ...
                            class="w-full text-3xl font-semibold outline-none resize-none bg-transparent text-black hide-scrollbar mb-1"
                        />
                    </div>
                    <div
                        ...
                        class="w-full min-h-111 outline-none text-black"
                        style="color: #000000;"
